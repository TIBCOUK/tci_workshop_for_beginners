...
In this section, you will need to import the API Specifications which were downloaded and unzipped to your local hard drive from this Github repository.

To import additional API specifications you will need to:
