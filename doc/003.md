...
Once you have changed Regions you can click on the **APIs** hexagon and you will see a screen similar to this:

![Mashery](images/mashery.png)

If you do see a **Start Trial** message - you will need to click on the link to activate your Mashery 30 day trial and follow the same procedure as when you signed up to the TIBCO Cloud.

When activated, you can choose the **Control Centre** option in order to start the Mashery configuration. You will need to take note of your Mashery **Area** as this will be used in subsequent steps. Your Mashery Area is found on the top right hand of the web page and looks like: **eval12345** as in the screenshot below:

![MasheryArea](images/masheryarea.png)
